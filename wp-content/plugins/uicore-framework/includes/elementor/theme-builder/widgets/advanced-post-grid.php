...
class AdvancedPostGrid extends Widget_Base
{
    ...
    protected function get_post_image()
    {
        ...
        $size = 'uicore-medium';
        ?>
        <a class="ui-e-post-img-wrapp" href="<?php echo esc_url( get_permalink() );?>" title="<?php echo __('View Post:','uicore-framework') . esc_html(get_the_title()) ?>">
    ...
    protected function get_post_title()
    {
        ...
        ?>
        <a href="<?php echo esc_url( get_permalink() );?>" title="<?php echo __('View Post:','uicore-framework') . esc_html(get_the_title()) ?>">
    ...
    function get_button(){
        ...
        $this->add_link_attributes( 'button', ['url'=>get_the_permalink()] );
