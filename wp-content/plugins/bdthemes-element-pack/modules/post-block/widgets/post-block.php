		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-post-block .bdt-post-block-read-more svg' => 'fill: {{VALUE}} !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-post-block .bdt-post-block-read-more:hover svg' => 'fill: {{VALUE}} !important;',
				],
			]
		);
