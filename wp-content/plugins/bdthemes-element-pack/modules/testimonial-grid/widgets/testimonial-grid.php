...
?>
    ...
    ?>
        <h4 class="bdt-testimonial-grid-title bdt-margin-remove-bottom"><?php echo esc_attr(get_the_title($post_id)); ?>
        ...
        ?>
            <div id="bdt-testimonial-grid-<?php echo $this->get_id(); ?>" <?php echo $this->get_render_attribute_string('testimonial-grid'); ?>>
                ...
                while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
                    <?php if ($settings['show_filter_bar']) {
                        $this->add_render_attribute('testimonial-grid-item', 'data-filter', $this->filter_menu_terms(), true);
                    } ?>
